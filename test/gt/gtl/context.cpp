...
BOOST_AUTO_TEST_CASE( Context_functional ) {
    ...
    GT::GTL::ParamPtr  numberParam               = GT::GTL::ParamPtr(new GT::GTL::NumberParam(numberParamValue));
    GT::IdentifierPtr  numberParamIdentifierName = GT::createIdentifierPtr("numberParamIdentifier");
    GT::GTL::ParamPtr  numberParamIdentifier     = GT::GTL::ParamPtr(new GT::GTL::IdentifierParam(*numberParamName));
    ...
    GT::GTL::ParamPtr  objectParam               = GT::GTL::ParamPtr(new GT::GTL::ObjectParam(objectParamValue));
    GT::IdentifierPtr  objectParamIdentifierName = GT::createIdentifierPtr("objectParamIdentifier");
    GT::GTL::ParamPtr  objectParamIdentifier     = GT::GTL::ParamPtr(new GT::GTL::IdentifierParam(*objectParamName));
    ...
    GT::GTL::ParamPtr  cyclicParam1              = GT::GTL::ParamPtr(new GT::GTL::IdentifierParam(*cyclicParam2Name));
    GT::GTL::ParamPtr  cyclicParam2              = GT::GTL::ParamPtr(new GT::GTL::IdentifierParam(*cyclicParam1Name));
