...
BOOST_AUTO_TEST_SUITE( PureGameBulder )

BOOST_AUTO_TEST_CASE( PureGameBuilder_functional ) {
    // given
    ...
    // when
    GT::Model::PureGameBuilder pureGameBuilder;
    pureGameBuilder.setPlayers(players);
    
    pureGameBuilder.clone()->addNextPositions(positions1).setParams(params1);
    pureGameBuilder.clone()->addNextPositions(positions2).setParams(params2);

    GT::Model::GamePtr game = pureGameBuilder.build();
...
BOOST_AUTO_TEST_CASE( PureGameBuilder_toString ) {
    // given
    GT::IdentifierPtr  playerName = GT::createIdentifierPtr("p1"); 
    GT::IdentifierPtr  strategy1  = GT::createIdentifierPtr("p1s1"); 
    GT::IdentifierPtr  strategy2  = GT::createIdentifierPtr("p1s2");
