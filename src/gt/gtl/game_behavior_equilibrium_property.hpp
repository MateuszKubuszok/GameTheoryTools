#ifndef GT_GTL_GAME_BEHAVIOR_EQUILIBRIUM_PROPERTY_HPP_INCLUDED
#define GT_GTL_GAME_BEHAVIOR_EQUILIBRIUM_PROPERTY_HPP_INCLUDED
...
#endif /* #ifndef GT_GTL_GAME_BEHAVIOR_EQUILIBRIUM_PROPERTY_HPP_INCLUDED */
