#ifndef GT_GTL_CHECKING_COORDINATE_DRIVER_HPP_INCLUDED
#define GT_GTL_CHECKING_COORDINATE_DRIVER_HPP_INCLUDED
...
#endif /* END GT_GTL_CHECKING_COORDINATE_DRIVER_HPP_INCLUDED */
