#ifndef GT_GTL_CHECKING_GAME_DRIVER_HPP_INCLUDED
#define GT_GTL_CHECKING_GAME_DRIVER_HPP_INCLUDED
...
#endif /* END #ifndef GT_GTL_CHECKING_GAME_DRIVER_HPP_INCLUDED */
