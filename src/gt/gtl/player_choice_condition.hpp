#ifndef GT_GTL_PLAYER_CHOICE_CONDITION_HPP_INCLUDED
#define GT_GTL_PLAYER_CHOICE_CONDITION_HPP_INCLUDED
...
#endif /* END #ifndef GT_GTL_PLAYER_CHOICE_CONDITION_HPP_INCLUDED */
