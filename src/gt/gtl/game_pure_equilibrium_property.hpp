#ifndef GT_GTL_GAME_PURE_EQUILIBRIUM_PROPERTY_HPP_INCLUDED
#define GT_GTL_GAME_PURE_EQUILIBRIUM_PROPERTY_HPP_INCLUDED
...
#endif /* #ifndef GT_GTL_GAME_PURE_EQUILIBRIUM_PROPERTY_HPP_INCLUDED */
