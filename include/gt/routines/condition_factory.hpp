#ifndef GT_ROUTINES_CONDITION_FACTORY_HPP_INCLUDED
#define GT_ROUTINES_CONDITION_FACTORY_HPP_INCLUDED
...
#endif /* END #ifndef GT_ROUTINES_CONDITION_FACTORY_HPP_INCLUDED */
