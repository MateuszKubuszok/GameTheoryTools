...
docelowo miał zostać zrealizowany projekt powinien był udostępniać możliwość wykorzystywania bibliotek języka \LANG{C} za
...
zastąpiła w nim bibliotekę \LIB{STL}, pozostałe komponenty biblioteki \LIB{Boost} zostały użyte jako uzupełnienie
biblioteki \LIB{STL}.

\subsection{Wewnętrzna struktura projektu}

(Niemal) wszystkie komponenty umieszczone zostały we wspólnej przestrzeni nazw \CODE{GT}, przy czym klasy zostały pogrupowane w kolejne 4 podprzestrzenie nazw:
\begin{itemize}
