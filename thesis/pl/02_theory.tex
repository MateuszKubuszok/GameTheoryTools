...
\begin{definition}
\textbf{Gra z informacją zupełną} to gra, w której każdy z graczy posiada wiedzę na temat ruchów i wypłat innych graczy,
\end{definition}
...
Podobnie w grach bez informacji zupełnej. Nawet znając wszystkie kroki prowadzące do danej sytuacji nie wiemy, jakie
decyzje mogą podjąć inni gracze. Nie wiemy też, jakie mogą otrzymać wypłaty, a tym samym przewidywać ich ruchów.

W takiej sytuacji można jednak znaleźć równowagę Nasha w \textbf{strategiach mieszanych} lub \textbf{zachowawczych}.
...
Tymczasem
\begin{definition}
\textbf{strategie zachowawcze} określają rozkład nad wyborem w określonym wierzchołku.
\end{definition}

Ponownie ograniczenia czasowe spowodowały, że jedynie najprostszy do rozpatrzenia przypadek wszedł w skład implementacji
projektu, zaś poszukiwanie równowag w strategiach mieszanych i zachowawczych przeznaczono do zaimplementowania
w przyszłości.
