...
\item biblioteki \LIB{Boost} w wersji co najmniej \VER{1.48} (\LIB{g++}) lub \VER{1.50.0-beta1} (\LIB{Clang++}),
...
pełnej biblioteki \LIB{Boost} i konieczne było ręcznie zbudowanie jej w wymaganej wersji/ręczne instalowanie plików
binarnych.
...
\PROG{Doxygen}. Przygotowano 3 jej konfiguracje do uruchomienia z katalogu głównego projektu, umieszczone w podkatalogu
...
Zdefiniowane imiennie dane dostępne są w ramach pewnego kontekstu. Gdy uruchamiany program inicjalizujemy pewien
...
definiuje one gracza \CODE{name}, o strategiach czystych \CODE{strategy1}, \CODE{strategy2}, ... W praktyce występuje
ona wyłącznie w połączeniu z poleceniem \CODE{LET ... BE ...;}:
