...
\CODE{PLAYER name \{ strategy1[, strategy2[, ...]] \}}
...
\CODE{LET player1 BE PLAYER \{ strategy1, strategy2 \};}

lub z \CODE{FIND ... FOR ...;}:

\CODE{FIND name, strategies FOR PLAYER name1 \{ strategy1, strategy2 \};}
...
LET game1 BE
  STRATEGIC GAME
  WITH
    player1, // gracz zdefiniowani wcześniej
  	PLAYER player2 { strategy1, strategy2 } // gracz zdefiniowany ad hoc
  SUCH AS
    { player1=strategy1: // częściowo definiuje kombinacje strategii
  	  { player2=strategy1: 10, 20 }, // uzupełnia kombinację o drugiego gracza
  	  { player2=strategy2: 30, 40 }
    },
    { player1=strategy2, player2=strategy1: 50, 60 }, // pełna kombinacja strategii graczy
...
\CODE{FIND pure\_equilibrium FOR game1;}
...
\CODE{FIND mixed\_equilibrium FOR game1;}
